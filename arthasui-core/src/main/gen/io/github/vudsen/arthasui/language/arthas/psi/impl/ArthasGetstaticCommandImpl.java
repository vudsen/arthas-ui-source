...
public class ArthasGetstaticCommandImpl extends ArthasCommandImpl implements ArthasGetstaticCommand {

  public ArthasGetstaticCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitGetstaticCommand(this);
  }
