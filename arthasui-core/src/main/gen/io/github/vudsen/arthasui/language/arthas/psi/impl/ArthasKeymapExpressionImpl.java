...
public class ArthasKeymapExpressionImpl extends ArthasCommandImpl implements ArthasKeymapExpression {

  public ArthasKeymapExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitKeymapExpression(this);
  }
