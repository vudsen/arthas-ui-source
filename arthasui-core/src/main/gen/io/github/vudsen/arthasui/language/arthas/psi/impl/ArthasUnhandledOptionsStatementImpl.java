...
public class ArthasUnhandledOptionsStatementImpl extends ArthasCommandImpl implements ArthasUnhandledOptionsStatement {

  public ArthasUnhandledOptionsStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitUnhandledOptionsStatement(this);
  }
