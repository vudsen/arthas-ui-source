...
public class ArthasUnhandledPerfcounterExpressionImpl extends ArthasCommandImpl implements ArthasUnhandledPerfcounterExpression {

  public ArthasUnhandledPerfcounterExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitUnhandledPerfcounterExpression(this);
  }
