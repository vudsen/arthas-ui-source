...
public class ArthasScCommandImpl extends ArthasCommandImpl implements ArthasScCommand {

  public ArthasScCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitScCommand(this);
  }
