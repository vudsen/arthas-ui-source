...
public class ArthasDumpCommandImpl extends ArthasCommandImpl implements ArthasDumpCommand {

  public ArthasDumpCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitDumpCommand(this);
  }
