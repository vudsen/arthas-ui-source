...
public class ArthasMcCommandImpl extends ArthasCommandImpl implements ArthasMcCommand {

  public ArthasMcCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitMcCommand(this);
  }
