...
public class ArthasBase64CommandImpl extends ArthasCommandImpl implements ArthasBase64Command {

  public ArthasBase64CommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitBase64Command(this);
  }
