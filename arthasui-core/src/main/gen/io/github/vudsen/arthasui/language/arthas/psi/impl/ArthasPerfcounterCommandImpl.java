...
public class ArthasPerfcounterCommandImpl extends ArthasCommandImpl implements ArthasPerfcounterCommand {

  public ArthasPerfcounterCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitPerfcounterCommand(this);
  }
