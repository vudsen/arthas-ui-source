...
public class ArthasJadExpressionImpl extends ArthasCommandImpl implements ArthasJadExpression {

  public ArthasJadExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitJadExpression(this);
  }
