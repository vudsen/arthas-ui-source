...
public class ArthasDashboardCommandImpl extends ArthasCommandImpl implements ArthasDashboardCommand {

  public ArthasDashboardCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitDashboardCommand(this);
  }
