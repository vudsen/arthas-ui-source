...
public class ArthasAuthExpressionImpl extends ArthasCommandImpl implements ArthasAuthExpression {

  public ArthasAuthExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitAuthExpression(this);
  }
