...
public class ArthasHeapdumpStatementImpl extends ArthasCommandImpl implements ArthasHeapdumpStatement {

  public ArthasHeapdumpStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitHeapdumpStatement(this);
  }
