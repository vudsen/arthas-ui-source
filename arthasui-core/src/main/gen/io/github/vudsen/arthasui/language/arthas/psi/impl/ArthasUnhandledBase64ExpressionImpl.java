...
public class ArthasUnhandledBase64ExpressionImpl extends ArthasCommandImpl implements ArthasUnhandledBase64Expression {

  public ArthasUnhandledBase64ExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitUnhandledBase64Expression(this);
  }
