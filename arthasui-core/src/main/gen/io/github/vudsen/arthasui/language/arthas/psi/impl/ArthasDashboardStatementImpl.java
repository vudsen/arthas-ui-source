...
public class ArthasDashboardStatementImpl extends ArthasCommandImpl implements ArthasDashboardStatement {

  public ArthasDashboardStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitDashboardStatement(this);
  }
