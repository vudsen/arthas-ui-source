...
public class ArthasMcStatementImpl extends ArthasCommandImpl implements ArthasMcStatement {

  public ArthasMcStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitMcStatement(this);
  }
