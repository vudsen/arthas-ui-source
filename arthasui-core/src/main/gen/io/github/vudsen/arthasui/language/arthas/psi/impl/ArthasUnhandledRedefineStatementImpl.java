...
public class ArthasUnhandledRedefineStatementImpl extends ArthasCommandImpl implements ArthasUnhandledRedefineStatement {

  public ArthasUnhandledRedefineStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitUnhandledRedefineStatement(this);
  }
