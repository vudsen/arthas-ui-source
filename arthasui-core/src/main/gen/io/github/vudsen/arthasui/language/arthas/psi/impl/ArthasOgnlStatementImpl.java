...
public class ArthasOgnlStatementImpl extends ArthasCommandImpl implements ArthasOgnlStatement {

  public ArthasOgnlStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitOgnlStatement(this);
  }
