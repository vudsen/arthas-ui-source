...
public class ArthasThreadExpressionImpl extends ArthasCommandImpl implements ArthasThreadExpression {

  public ArthasThreadExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
