...
public class ArthasJadCommandImpl extends ArthasCommandImpl implements ArthasJadCommand {

  public ArthasJadCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitJadCommand(this);
  }
