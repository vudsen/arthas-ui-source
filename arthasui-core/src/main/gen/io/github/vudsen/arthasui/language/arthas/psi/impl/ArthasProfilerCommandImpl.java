...
public class ArthasProfilerCommandImpl extends ArthasCommandImpl implements ArthasProfilerCommand {

  public ArthasProfilerCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitProfilerCommand(this);
  }
