...
public class ArthasJvmCommandImpl extends ArthasCommandImpl implements ArthasJvmCommand {

  public ArthasJvmCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitJvmCommand(this);
  }
