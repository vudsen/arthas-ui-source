...
public class ArthasStopCommandImpl extends ArthasCommandImpl implements ArthasStopCommand {

  public ArthasStopCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitStopCommand(this);
  }
