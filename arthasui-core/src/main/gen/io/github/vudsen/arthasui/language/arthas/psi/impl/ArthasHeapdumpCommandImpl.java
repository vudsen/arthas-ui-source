...
public class ArthasHeapdumpCommandImpl extends ArthasCommandImpl implements ArthasHeapdumpCommand {

  public ArthasHeapdumpCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitHeapdumpCommand(this);
  }
