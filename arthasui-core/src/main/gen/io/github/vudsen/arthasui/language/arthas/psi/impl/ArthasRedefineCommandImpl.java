...
public class ArthasRedefineCommandImpl extends ArthasCommandImpl implements ArthasRedefineCommand {

  public ArthasRedefineCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitRedefineCommand(this);
  }
