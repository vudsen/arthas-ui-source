...
public class ArthasVersionCommandImpl extends ArthasCommandImpl implements ArthasVersionCommand {

  public ArthasVersionCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitVersionCommand(this);
  }
