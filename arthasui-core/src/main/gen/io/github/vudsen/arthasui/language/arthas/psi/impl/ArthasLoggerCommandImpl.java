...
public class ArthasLoggerCommandImpl extends ArthasCommandImpl implements ArthasLoggerCommand {

  public ArthasLoggerCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitLoggerCommand(this);
  }
