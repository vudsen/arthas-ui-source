...
public class OgnlClazzPackageImpl extends ASTWrapperPsiElement implements OgnlClazzPackage {

  public OgnlClazzPackageImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OgnlVisitor visitor) {
    visitor.visitClazzPackage(this);
  }
