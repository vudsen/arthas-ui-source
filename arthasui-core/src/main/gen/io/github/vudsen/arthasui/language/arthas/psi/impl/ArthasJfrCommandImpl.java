...
public class ArthasJfrCommandImpl extends ArthasCommandImpl implements ArthasJfrCommand {

  public ArthasJfrCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitJfrCommand(this);
  }
