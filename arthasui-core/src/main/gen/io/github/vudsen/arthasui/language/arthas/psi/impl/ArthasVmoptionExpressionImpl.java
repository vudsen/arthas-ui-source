...
public class ArthasVmoptionExpressionImpl extends ArthasCommandImpl implements ArthasVmoptionExpression {

  public ArthasVmoptionExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitVmoptionExpression(this);
  }
