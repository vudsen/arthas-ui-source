...
public class ArthasMbeanCommandImpl extends ArthasCommandImpl implements ArthasMbeanCommand {

  public ArthasMbeanCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitMbeanCommand(this);
  }
