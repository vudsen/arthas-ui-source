...
public class ArthasMonitorCommandImpl extends ArthasCommandImpl implements ArthasMonitorCommand {

  public ArthasMonitorCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitMonitorCommand(this);
  }
