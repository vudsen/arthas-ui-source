...
public class ArthasCatCommandImpl extends ArthasCommandImpl implements ArthasCatCommand {

  public ArthasCatCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitCatCommand(this);
  }
