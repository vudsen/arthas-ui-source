...
public class ArthasOptionsCommandImpl extends ArthasCommandImpl implements ArthasOptionsCommand {

  public ArthasOptionsCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitOptionsCommand(this);
  }
