...
public class ArthasClsCommandImpl extends ArthasCommandImpl implements ArthasClsCommand {

  public ArthasClsCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitClsCommand(this);
  }
