...
public class ArthasSysenvCommandImpl extends ArthasCommandImpl implements ArthasSysenvCommand {

  public ArthasSysenvCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitSysenvCommand(this);
  }
