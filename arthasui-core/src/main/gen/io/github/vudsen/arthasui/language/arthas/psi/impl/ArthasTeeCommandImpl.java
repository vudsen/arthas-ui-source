...
public class ArthasTeeCommandImpl extends ArthasCommandImpl implements ArthasTeeCommand {

  public ArthasTeeCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitTeeCommand(this);
  }
