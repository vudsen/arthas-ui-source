...
public class ArthasUnhandledGrepExpressionImpl extends ArthasCommandImpl implements ArthasUnhandledGrepExpression {

  public ArthasUnhandledGrepExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitUnhandledGrepExpression(this);
  }
