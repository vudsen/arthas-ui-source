...
public class ArthasUnhandledProfilerStatementImpl extends ArthasCommandImpl implements ArthasUnhandledProfilerStatement {

  public ArthasUnhandledProfilerStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitUnhandledProfilerStatement(this);
  }
