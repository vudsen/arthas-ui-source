...
public class ArthasClassloaderExpressionImpl extends ArthasCommandImpl implements ArthasClassloaderExpression {

  public ArthasClassloaderExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitClassloaderExpression(this);
  }
