...
public class ArthasUnhandledMonitorStatementImpl extends ArthasCommandImpl implements ArthasUnhandledMonitorStatement {

  public ArthasUnhandledMonitorStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitUnhandledMonitorStatement(this);
  }
