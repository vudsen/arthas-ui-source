...
public class ArthasSessionExpressionImpl extends ArthasCommandImpl implements ArthasSessionExpression {

  public ArthasSessionExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitSessionExpression(this);
  }
