...
public class ArthasUnhandledGetstaticExpressionImpl extends ArthasCommandImpl implements ArthasUnhandledGetstaticExpression {

  public ArthasUnhandledGetstaticExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitUnhandledGetstaticExpression(this);
  }
