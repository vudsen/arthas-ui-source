...
public class ArthasUnhandledMbeanStatementImpl extends ArthasCommandImpl implements ArthasUnhandledMbeanStatement {

  public ArthasUnhandledMbeanStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitUnhandledMbeanStatement(this);
  }
