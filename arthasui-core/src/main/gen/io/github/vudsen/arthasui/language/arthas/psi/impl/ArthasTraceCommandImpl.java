...
public class ArthasTraceCommandImpl extends ArthasCommandImpl implements ArthasTraceCommand {

  public ArthasTraceCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitTraceCommand(this);
  }
