...
public class ArthasTtTStatementImpl extends ArthasCommandImpl implements ArthasTtTStatement {

  public ArthasTtTStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitTtTStatement(this);
  }
