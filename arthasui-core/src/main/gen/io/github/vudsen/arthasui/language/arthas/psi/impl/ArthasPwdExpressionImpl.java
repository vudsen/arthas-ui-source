...
public class ArthasPwdExpressionImpl extends ArthasCommandImpl implements ArthasPwdExpression {

  public ArthasPwdExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitPwdExpression(this);
  }
