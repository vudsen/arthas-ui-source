...
public class ArthasClassloaderCommandImpl extends ArthasCommandImpl implements ArthasClassloaderCommand {

  public ArthasClassloaderCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitClassloaderCommand(this);
  }
