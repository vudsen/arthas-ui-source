...
public class ArthasUnhandledTeeExpressionImpl extends ArthasCommandImpl implements ArthasUnhandledTeeExpression {

  public ArthasUnhandledTeeExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitUnhandledTeeExpression(this);
  }
