...
public class ArthasHistoryExpressionImpl extends ArthasCommandImpl implements ArthasHistoryExpression {

  public ArthasHistoryExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitHistoryExpression(this);
  }
  ...
  @Override
  @Nullable
  public ArthasArgument getArgument() {
    return findChildByClass(ArthasArgument.class);
  }
