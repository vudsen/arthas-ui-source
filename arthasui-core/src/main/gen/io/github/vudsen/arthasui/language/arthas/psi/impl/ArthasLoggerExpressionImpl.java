...
public class ArthasLoggerExpressionImpl extends ArthasCommandImpl implements ArthasLoggerExpression {

  public ArthasLoggerExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitLoggerExpression(this);
  }
