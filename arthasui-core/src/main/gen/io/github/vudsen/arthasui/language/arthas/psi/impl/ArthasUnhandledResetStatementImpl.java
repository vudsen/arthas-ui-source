...
public class ArthasUnhandledResetStatementImpl extends ArthasCommandImpl implements ArthasUnhandledResetStatement {

  public ArthasUnhandledResetStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitUnhandledResetStatement(this);
  }
