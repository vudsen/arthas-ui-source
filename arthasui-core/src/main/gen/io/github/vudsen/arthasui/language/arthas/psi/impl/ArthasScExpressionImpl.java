...
public class ArthasScExpressionImpl extends ArthasCommandImpl implements ArthasScExpression {

  public ArthasScExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitScExpression(this);
  }
  ...
  @Override
  @NotNull
  public List<ArthasMethod> getMethodList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ArthasMethod.class);
  }
