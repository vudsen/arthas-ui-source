...
public class ArthasUnhandledVmtoolStatementImpl extends ArthasCommandImpl implements ArthasUnhandledVmtoolStatement {

  public ArthasUnhandledVmtoolStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitUnhandledVmtoolStatement(this);
  }
