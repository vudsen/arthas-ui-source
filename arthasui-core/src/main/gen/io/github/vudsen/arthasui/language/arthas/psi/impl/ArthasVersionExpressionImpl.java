...
public class ArthasVersionExpressionImpl extends ArthasCommandImpl implements ArthasVersionExpression {

  public ArthasVersionExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitVersionExpression(this);
  }
