...
public class ArthasEchoExpressionImpl extends ArthasCommandImpl implements ArthasEchoExpression {

  public ArthasEchoExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitEchoExpression(this);
  }
