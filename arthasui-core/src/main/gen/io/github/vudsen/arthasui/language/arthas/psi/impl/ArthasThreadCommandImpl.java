...
public class ArthasThreadCommandImpl extends ArthasCommandImpl implements ArthasThreadCommand {

  public ArthasThreadCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitThreadCommand(this);
  }
