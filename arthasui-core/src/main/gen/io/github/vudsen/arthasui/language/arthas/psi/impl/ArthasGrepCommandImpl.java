...
public class ArthasGrepCommandImpl extends ArthasCommandImpl implements ArthasGrepCommand {

  public ArthasGrepCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitGrepCommand(this);
  }
