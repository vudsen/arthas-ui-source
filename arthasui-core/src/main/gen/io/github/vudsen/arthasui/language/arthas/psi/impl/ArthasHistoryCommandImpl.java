...
public class ArthasHistoryCommandImpl extends ArthasCommandImpl implements ArthasHistoryCommand {

  public ArthasHistoryCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitHistoryCommand(this);
  }
