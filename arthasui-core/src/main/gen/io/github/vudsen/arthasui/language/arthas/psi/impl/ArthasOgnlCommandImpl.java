...
public class ArthasOgnlCommandImpl extends ArthasCommandImpl implements ArthasOgnlCommand {

  public ArthasOgnlCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitOgnlCommand(this);
  }
