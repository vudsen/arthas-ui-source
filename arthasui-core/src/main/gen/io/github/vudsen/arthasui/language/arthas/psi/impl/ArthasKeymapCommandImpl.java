...
public class ArthasKeymapCommandImpl extends ArthasCommandImpl implements ArthasKeymapCommand {

  public ArthasKeymapCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitKeymapCommand(this);
  }
