...
public class ArthasUnhandledDumpStatementImpl extends ArthasCommandImpl implements ArthasUnhandledDumpStatement {

  public ArthasUnhandledDumpStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitUnhandledDumpStatement(this);
  }
