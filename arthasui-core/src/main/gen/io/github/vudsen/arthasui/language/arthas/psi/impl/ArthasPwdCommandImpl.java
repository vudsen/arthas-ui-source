...
public class ArthasPwdCommandImpl extends ArthasCommandImpl implements ArthasPwdCommand {

  public ArthasPwdCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitPwdCommand(this);
  }
