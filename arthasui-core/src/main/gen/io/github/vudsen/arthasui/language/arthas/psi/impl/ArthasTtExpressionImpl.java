...
public class ArthasTtExpressionImpl extends ArthasCommandImpl implements ArthasTtExpression {

  public ArthasTtExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitTtExpression(this);
  }
