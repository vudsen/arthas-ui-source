...
public class ArthasSyspropCommandImpl extends ArthasCommandImpl implements ArthasSyspropCommand {

  public ArthasSyspropCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitSyspropCommand(this);
  }
