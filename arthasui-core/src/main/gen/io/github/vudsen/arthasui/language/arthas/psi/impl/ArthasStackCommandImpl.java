...
public class ArthasStackCommandImpl extends ArthasCommandImpl implements ArthasStackCommand {

  public ArthasStackCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitStackCommand(this);
  }
