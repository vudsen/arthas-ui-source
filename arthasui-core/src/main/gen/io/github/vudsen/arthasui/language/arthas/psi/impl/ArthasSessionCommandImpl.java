...
public class ArthasSessionCommandImpl extends ArthasCommandImpl implements ArthasSessionCommand {

  public ArthasSessionCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitSessionCommand(this);
  }
