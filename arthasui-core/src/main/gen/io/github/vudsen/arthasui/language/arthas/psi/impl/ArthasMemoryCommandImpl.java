...
public class ArthasMemoryCommandImpl extends ArthasCommandImpl implements ArthasMemoryCommand {

  public ArthasMemoryCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitMemoryCommand(this);
  }
