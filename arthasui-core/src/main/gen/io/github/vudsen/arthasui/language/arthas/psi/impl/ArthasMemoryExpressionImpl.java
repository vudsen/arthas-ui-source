...
public class ArthasMemoryExpressionImpl extends ArthasCommandImpl implements ArthasMemoryExpression {

  public ArthasMemoryExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitMemoryExpression(this);
  }
