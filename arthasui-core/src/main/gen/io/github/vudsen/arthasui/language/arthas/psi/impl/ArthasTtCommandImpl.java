...
public class ArthasTtCommandImpl extends ArthasCommandImpl implements ArthasTtCommand {

  public ArthasTtCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitTtCommand(this);
  }
