...
public class ArthasVmoptionCommandImpl extends ArthasCommandImpl implements ArthasVmoptionCommand {

  public ArthasVmoptionCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitVmoptionCommand(this);
  }
