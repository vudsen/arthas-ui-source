...
public class ArthasSyspropExpressionImpl extends ArthasCommandImpl implements ArthasSyspropExpression {

  public ArthasSyspropExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArthasVisitor visitor) {
    visitor.visitSyspropExpression(this);
  }
